package com.collect.money.service.bus.cache;

import com.collect.money.domain.bus.entity.Customer;
import com.collect.money.domain.bus.entity.Goods;
import com.collect.money.service.sys.cache.CachePool;
...
public class BusinessCacheAspect {
     ...
     * 声明客户的切面表达式
     */
    private static final String POINTCUT_CUSTOMER_ADD="execution(* com.collect.money.service.bus.impl.CustomerServiceImpl.save(..))";
    private static final String POINTCUT_CUSTOMER_UPDATE="execution(* com.collect.money.service.bus.impl.CustomerServiceImpl.updateById(..))";
    private static final String POINTCUT_CUSTOMER_GET="execution(* com.collect.money.service.bus.impl.CustomerServiceImpl.getById(..))";
    private static final String POINTCUT_CUSTOMER_DELETE="execution(* com.collect.money.service.bus.impl.CustomerServiceImpl.removeById(..))";
    private static final String POINTCUT_CUSTOMER_BATCHDELETE="execution(* com.collect.money.service.bus.impl.CustomerServiceImpl.removeByIds(..))";
     ...
     * 声明商品的切面表达式
     */
    private static final String POINTCUT_GOODS_ADD="execution(* com.collect.money.service.bus.impl.GoodsServiceImpl.save(..))";
    private static final String POINTCUT_GOODS_UPDATE="execution(* com.collect.money.service.bus.impl.GoodsServiceImpl.updateById(..))";
    private static final String POINTCUT_GOODS_GET="execution(* com.collect.money.service.bus.impl.GoodsServiceImpl.getById(..))";
    private static final String POINTCUT_GOODS_DELETE="execution(* com.collect.money.service.bus.impl.GoodsServiceImpl.removeById(..))";
